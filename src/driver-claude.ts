...
export async function doClaudeStream(opts) {
    // Map model aliases to actual model IDs based on provider
    let model = normalizeClaudeModelId(opts.claudeModel);
...
const CLAUDE_MODELS = [
    ...
    { id: 'qwen3.5-plus', alias: 'ali-qwen3.5' },
    { id: 'qwen3-max-2026-01-23', alias: 'ali-qwen-max' },
    { id: 'qwen3-coder-plus', alias: 'ali-qwen-coder' },
    { id: 'qwen3-coder-next', alias: 'ali-qwen-next' },
    { id: 'kimi-k2.5', alias: 'ali-kimi' },
    // Zhipu models
    { id: 'glm-5', alias: 'ali-glm-5' },
    { id: 'glm-4.7', alias: 'ali-glm-4.7' },
    // Volcengine models
    { id: 'ark-code-latest', alias: 'ark-code' },
    { id: 'doubao-seed-code', alias: 'ark-doubao-code' },
    { id: 'doubao-seed-2.0-code', alias: 'ark-doubao-2.0-code' },
    { id: 'doubao-seed-2.0-pro', alias: 'ark-doubao-2.0-pro' },
    { id: 'doubao-seed-2.0-lite', alias: 'ark-doubao-2.0-lite' },
    { id: 'kimi-k2.5', alias: 'ark-kimi' },
    { id: 'MiniMax-M2.5', alias: 'ark-minimax' },
    { id: 'deepseek-v3.2', alias: 'ark-deepseek' },
];
// ---------------------------------------------------------------------------
// Usage
// ---------------------------------------------------------------------------
